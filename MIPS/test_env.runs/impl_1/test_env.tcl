...
set rc [catch {
  ...
  add_files -quiet {{C:/Users/Horea/Desktop/Campean Casiana - Copy/Campean Casiana/test_env/test_env.runs/synth_1/test_env.dcp}}
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file test_env_timing_summary_routed.rpt -rpx test_env_timing_summary_routed.rpx -warn_on_violation "
